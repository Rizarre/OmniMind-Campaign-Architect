...
export default function ExportCenter() {
    ...
    if (!currentPlan) {
        return (
            <div className="container mx-auto p-12 max-w-4xl min-h-[80vh] flex items-center justify-center relative z-10">
                <Card className="p-16 border-white/5 border-dashed border-2 rounded-[3rem] relative overflow-hidden group text-center max-w-xl">
    ...
    return (
        <div className="min-h-screen bg-transparent text-slate-200 relative z-10">
            <div className="container mx-auto p-8 max-w-4xl space-y-10 animate-in fade-in slide-in-from-bottom-4 duration-1000">
                <div className="space-y-2">
                    <div className="flex items-center gap-3 mb-2">
                        <div className="px-3 py-1 bg-green-500/10 rounded-full border border-green-500/20">
                            <span className="text-xs font-black text-green-400 uppercase tracking-[0.2em]">Ready for Deployment</span>
                        </div>
                    </div>
                ...
                <div className="grid gap-6">
                    {/* JSON Export */}
                    <Card className="p-8 md:p-10 border-white/5 shadow-2xl rounded-[2.5rem] relative overflow-hidden group hover:border-blue-500/30 transition-all duration-500">
                        ...
                        <div className="flex flex-col md:flex-row items-start justify-between gap-8 relative z-10">
                            <div className="flex gap-6">
                                <div className="p-5 bg-black/40 backdrop-blur-md rounded-2xl border border-white/5">
                    ...
                    {/* Markdown Export */}
                    <Card className="p-8 md:p-10 border-white/5 shadow-2xl rounded-[2.5rem] relative overflow-hidden group hover:border-purple-500/30 transition-all duration-500">
                    ...
                    {/* PDF Export */}
                    <Card className="p-8 md:p-10 border-white/5 shadow-2xl rounded-[2.5rem] relative overflow-hidden group hover:border-green-500/30 transition-all duration-500">
